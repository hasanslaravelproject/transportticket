                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <div class="logo">
                                            <center>
                                                <h2 style="color: #fff; padding: 10px;">Bus Schedule : successfully booked ticket</h2>
                                            </center>
                                        ...
                                        <br>
                                        @if($details['payment_method'] == 'online')
                                            <a href="#" style="background: #0f00f3; padding: 10px 25px; color: #fff; text-decoration: none; border-radius: 3px;">Pay now</a>
                                        @endif

                                        <a type='button' id='btn' style="background: #2b743b; cursor: pointer; padding: 10px 25px; color: #fff; text-decoration: none; border-radius: 3px;" onclick='printDiv();'>Print</a>
                                        <br>
                                        <br>
                                        <center>
